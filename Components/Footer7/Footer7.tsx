...
function Footer7(props: IProps) {
  return (
    <Container fluid className="Footer7-Body p-0">
                ...
                <div className="links mt-4 ">
                  <div className="d-flex mt-2 mb-2 ">
                    <div className="icon1 me-2  mt-auto mb-auto ">
                      <GoLocation color="black" className="ms-2 mt-1" />
                    </div>
                    <div
                      className="address"
                      dangerouslySetInnerHTML={{
                  ...
                  <div className="d-flex mt-2 mb-2 ">
                    <div className="icon2 me-2  mt-auto mb-auto ">
                      <BiPhoneCall color="black" className="ms-2 mt-1" />
                    </div>
                    <div
                      className="address"
                      dangerouslySetInnerHTML={{
                  ...
                  <div className="d-flex mt-2 mb-2 ">
                    <div className="icon3 me-2  mt-auto mb-auto ">
                      <AiOutlineMail color="black" className="ms-2 mt-1" />
                    </div>
                    <div
                      className="address"
                      dangerouslySetInnerHTML={{
